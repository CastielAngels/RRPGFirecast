...
function newOsMundosDosMortosfrm()
    ...
    obj.label17:setText("Programador: CastielAngels");
    ...
    obj.label18:setText("Os Mundos Dos Mortos RRPG Firecast");
    ...
    obj.label19:setText("Versão: 1.0b");
    ...
    obj.label20:setText("Por favor, mantenha seu plugin atualizado.");
