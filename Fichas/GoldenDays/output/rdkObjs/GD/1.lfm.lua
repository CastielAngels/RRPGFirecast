...
local function constructNew_GoldenDays01()
...
function newGoldenDays01()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_GoldenDays01();
      end,
      function()
...
GoldenDays01 = _GoldenDays01;
Firecast.registrarForm(_GoldenDays01);

return _GoldenDays01;
