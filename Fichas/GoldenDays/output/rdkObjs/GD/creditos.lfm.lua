...
local function constructNew_GoldenDaysC()
    ...
    obj.image1:setSRC("/GD/img/GoldenDays.jpg");
    ...
    obj.label2:setText("Golden Days RRPG Firecast");
    ...
    obj.label3:setText("Versão: 1.0Alpha 01/12/18");
...
function newGoldenDaysC()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_GoldenDaysC();
      end,
      function()
...
GoldenDaysC = _GoldenDaysC;
Firecast.registrarForm(_GoldenDaysC);
