...
local function constructNew_TormentaCastfrm()
    ...
    obj.ChangelingC = GUI.fromHandle(_obj_newObject("form"));
    obj.ChangelingC:setParent(obj.tab2);
    obj.ChangelingC:setName("ChangelingC");
    obj.ChangelingC:setAlign("client");
    obj.ChangelingC:setTheme("dark");

    obj.rectangle23 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle23:setParent(obj.ChangelingC);
    obj.rectangle23:setAlign("top");
    obj.rectangle23:setHeight(30);
    obj.rectangle23:setColor("gray");
    obj.rectangle23:setName("rectangle23");

    obj.flowLayout1 = GUI.fromHandle(_obj_newObject("flowLayout"));
    obj.flowLayout1:setParent(obj.ChangelingC);
    ...
    obj.rectangle24:setParent(obj.flowPart1);
    obj.rectangle24:setTop(10);
    obj.rectangle24:setWidth(500);
    ...
    obj.layout22:setParent(obj.flowPart1);
    obj.layout22:setLeft(140);
    obj.layout22:setTop(28);
    ...
    obj.label20:setFontColor("silver");
    obj.label20:setHeight(20);
    obj.label20:setText("Programador: CastielAngels");
    ...
    obj.label21:setWidth(250);
    obj.label21:setFontColor("silver");
    obj.label21:setHeight(20);
    obj.label21:setText("Tormenta RRPG Firecast");
    ...
    obj.label22:setFontColor("silver");
    obj.label22:setHeight(20);
    obj.label22:setText("Versão: 1.0a 02/08/18");
    ...
    obj.label23:setFontColor("silver");
    obj.label23:setHeight(20);
    obj.label23:setText("Por favor, mantenha seu plugin atualizado.");
    ...
    function obj:destroy() 
        ...
        if self.ChangelingC ~= nil then self.ChangelingC:destroy(); self.ChangelingC = nil; end;
