...
local _firedriveForm = {
    newEditor = newfiredriveForm, 
    new = newfiredriveForm, 
    name = "firedriveForm", 
    dataType = "", 
    formType = "undefined", 
...
firedriveForm = _firedriveForm;
rrpg.registrarForm(_firedriveForm);

return _firedriveForm;
